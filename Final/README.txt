...
operação de busca e que todos os arquivos seriam extraídos de uma única
vez.
...
Em seguida temos a primeira área de dados, onde encontramos a relação de
...
Uma seção de ajuda pode ser exibida utilizando-se as opções -h ou -a.